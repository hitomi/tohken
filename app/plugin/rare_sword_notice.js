    ...
    store.subscribe((mutation, state) => {
      if (state.config.rare_sword_notice == true) {
        if (mutation.type === 'battle/updateBattle' || mutation.type === 'battle/updatePracticeBattle') {
          ...
          if ([3, 5, 9, 13, 15, 17, 25, 31, 33, 35, 37, 43, 51, 53, 55, 57, 59, 63, 67, 69, 71, 75, 77, 79, 103, 105, 107, 112, 120, 124, 130, 136, 140, 142, 144, 146, 148, 150, 152, 154, 156].indexOf(getSwordId) == -1) return
